...
const Logo = () => {
    ...
    const title = 'Cycle Active Record';
...
const config: DocsThemeConfig = {
    ...
    project:
        {
            link: 'https://github.com/cycle/active-record',
        }
    ,
    docsRepositoryBase: 'https://github.com/wayofdev/next-docs-active-record/tree/master/docs',
    footer:
        {
            text: 'Cycle Active Record Documentation',
        }
    ,
    useNextSeoProps() {
        return {
            titleTemplate: '%s | Cycle-Active-Record',
            themeColor: '#fff',
            description: 'Laravel package that provides Cycle ORM integration.',
            openGraph: {
                type: 'website',
                locale: 'en_US',
                url: 'https://active-record.wayof.dev',
                site_name: 'Cycle-Active-Record',
                images: [
                    {
                        url: 'https://active-record.wayof.dev/og.png',
                        width: 1200,
                        height: 630,
                        alt: 'Cycle-Active-Record',
                    },
                ],
            },
            additionalLinkTags: [
    ...
    head: function useHead() {
        ...
        const socialCard = 'https://active-record.wayof.dev/og.png'
        const currentTitle = title ? title + ' | Cycle-Active-Record' : 'Cycle-Active-Record'
        const description = 'Provides Active Record implementation for Cycle ORM.'
        ...
        return (
            <>
                ...
                <meta name="twitter:site:domain" content="active-record.wayof.dev"/>
                <meta name="twitter:url" content="active-record.wayof.dev"/>
